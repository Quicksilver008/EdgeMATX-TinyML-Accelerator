...
always @(in1, in2, op_select) begin
    ...
    case(op_select)
        ...
        // RV32I: shift amount is always the lower 5 bits of in2 (shamt field)
        5: begin out = in1 << in2[4:0]; zero_flag = 0; end
        6: begin out = in1 >> in2[4:0]; zero_flag = 0; end
        7: begin out = $signed(in1) >>> in2[4:0]; zero_flag = 0; end
